      ...
      <section className="max-w-content mx-auto px-10 mt-10">
        <div className="bg-gradient-to-br from-[#F89B4D] via-orange to-[#E0580A] rounded-lg p-[32px_28px] text-white grid grid-cols-[1fr_1px_1fr_1px_1fr] gap-6 shadow-[0_4px_18px_rgba(232,90,12,.22)]">
          <div className="text-center px-2.5">
            ...
            <p className="text-[14.5px] leading-[1.55] m-0 font-semibold opacity-[.96]">Contribuir com a saúde e a qualidade de vida das famílias brasileiras.</p>
          </div>
          <div className="bg-white/40 w-px" />
          <div className="text-center px-2.5">
            <h3 className="text-white text-[22px] font-[800] mb-2 tracking-[.3px]">Visão</h3>
            <p className="text-[14.5px] leading-[1.55] m-0 font-semibold opacity-[.96]">Continuar a expansão do negócio, tornando-se referência nos segmentos de suplementos alimentares e cosméticos.</p>
          </div>
          <div className="bg-white/40 w-px" />
          <div className="text-center px-2.5">
            <h3 className="text-white text-[22px] font-[800] mb-2 tracking-[.3px]">Valores</h3>
            <p className="text-[14.5px] leading-[1.55] m-0 font-semibold opacity-[.96]">Compromisso, qualidade, respeito, entusiasmo, credibilidade, perseverança e orgulho nordestino.</p>
          </div>
        </div>
      </section>
